...
<HTML>
	...
	<BODY bgproperties="fixed" oncontextmenu="return false" ondragstart="return" onselectstart="return false">
		<CENTER>
...
제 1 조 (목적) 
이 이용약관(이하 '약관'이라 합니다)은 NHN주식회사(이하 '회사'라 합니다)와 이용 고객(이하 '회원'이라 합니다)간에 회사가 제공하는 네이버 서비스(http://www.naver.com, 이하 '네이버' 또는 '서비스'라 합니다)의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.
...
제 3 조 (이용약관의 효력 및 변경) 
(1) 이 약관은 네이버를 통해 온라인으로 공시하고 회원의 동의와 회사의 승낙으로 효력을 발생하며, 합리적인 사유가 발생할 경우 회사는 관련 법령에 위배되지 않는 범위 안에서 개정할 수 있습니다. 개정된 약관은 정당한 절차에 따라 네이버를 통해 공지함으로써 효력을 발휘합니다.
(2) 회원은 정기적으로 네이버를 방문하여 약관의 변경사항을 확인하여야 합니다. 변경된 약관에 대한 정보를 알지 못해 발생하는 회원의 피해는 회사에서 책임지지 않습니다.
...
제 7 조 (개인정보의 보호 및 사용) 
(1) 회사는 관계 법령이 정하는 바에 따라 회원의 개인정보를 보호하기 위해 노력합니다. 개인정보의 보호 및 사용에 대해서는 관련 법령 및 회사의 개인정보취급방침이 적용됩니다. 단, 회사의 공식 사이트 이외의 링크된 사이트에서는 회사의 개인정보취급방침이 적용되지 않습니다. 또한, 회원은 비밀번호 등이 타인에게 노출되지 않도록 철저히 관리해야 하며 회사는 회원의 귀책사유로 인해 노출된 정보에 대해서  책임을 지지 않습니다.
...
(3) 네이버의 이용자ID는 회원 본인의 동의 하에 회사 또는 자회사가 운영하는 사이트의 회원ID와 연결될 수 있습니다.
...
(3) 회사는 개인정보 보호를 위해 보안시스템을 구축하며 개인정보취급방침을 공시하고 준수합니다.
...
제 12 조 (서비스 이용 시간) 
(1) 서비스 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을 원칙으로 합니다. 단, 회사는 시스템 정기점검, 증설 및 교체를 위해 회사가 정한 날이나 시간에 서비스를 일시 중단할 수 있으며, 예정되어 있는 작업으로 인한 서비스 일시 중단은 네이버를 통해 사전에 공지합니다.
...
(2) 회사는 이용계약을 해지하는 경우 네이버 개인정보취급방침에 따라 회원 등록을 말소합니다. 이 경우 회원에게 이를 통지하며, 회사가 직권으로 이용계약을 해지하고자 하는 경우에는 말소 전에 회원에게 소명의 기회를 부여합니다.
...
<부칙>
1. 본 약관은 2006년 1월 12일부터 적용됩니다.
2. 2002년 5월 9일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
						</PRE>
					</TD>
				</TR>
			</TABLE>
