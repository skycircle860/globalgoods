...
public class SupportListBean extends MainBean
{
	public void funcExecute() throws Exception
	{
		...
		System.out.println("SupportListBean perPage : "+perPage);
		System.out.println("articleStartNum : " + articleStartNum);
		System.out.println("articleEndNum : " + articleEndNum);
		...
		queryBuffer.append("a.TITLE, a.HIT_CNT, a.REG_ID, b.NAME, a.DISP_YN, ");
		...
		queryBuffer.append("WHERE a.REG_ID=b.ID AND a.CODE='"+code+"' ");
		if(!si.getReplyYn())
		{
		...
		queryBuffer.append("a.HIT_CNT, a.REG_ID, b.NAME, a.DISP_YN, a.REG_DATE ORDER BY GROUP_NUM ASC ");
		if(si.getReplyYn())
		{
			queryBuffer.append(", "+si.getReplySort()+" DESC ");
		}
