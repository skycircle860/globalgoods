...
public class InterestUpdateBean extends MainBean
{
	public void funcExecute() throws Exception
	{
		...
		queryBuffer.append("UPDATE INTEREST SET NAME = '" + name + "', USEYN='" + yn + "', UPD_ID='" + id + "', UPD_DATE=SYSDATE, UPD_IP='" + client + "' WHERE CODE = '" + code + "'");
