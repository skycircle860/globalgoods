...
public class OrderListPageBean extends MainBean
{
	public void funcExecute() throws Exception
	{
		...
		queryBuffer.append("SELECT COUNT(CODE) ORDER_CNT FROM ORDER_LIST ");
		queryBuffer.append("WHERE USEYN='Y'");

		DBExecute dbe = new DBExecute(queryBuffer.toString());
		ArrayList bbsInfoList = dbe.getDataList();

		Hashtable tempBbsInfoTable = (Hashtable)bbsInfoList.get(0);
		articleTotalNum = Integer.parseInt((String)tempBbsInfoTable.get("ORDER_CNT"));
