...
public class GoodsCartListBean extends MainBean
{
...
//파일꺼내기 ▲
		...
		queryBuffer.append("SELECT ROWNUM DATA_NUM, MEMBER_ID, GOODS_CODE,GOODS_AMOUNT SELECT_GOODS_AMOUNT, ");
		queryBuffer.append("REG_ID, UPD_DATE FROM CART_GOODS_LIST "); 
//파일꺼내기 ▼
		queryBuffer.append(") b, (SELECT CODE, PAR_PRICE, GOODS_AMOUNT, NAME GOODS_NAME FROM GOODS) c ");
		queryBuffer.append("WHERE b.GOODS_CODE=a.GOODS_CODE(+) AND MEMBER_ID = '"+id+"' AND b.GOODS_CODE = c.CODE ");
		queryBuffer.append("ORDER BY b.GOODS_CODE");
//파일꺼내기 ▲
		...
		for(int i=0; i<tempList.size(); i++)
		{
			...
			System.out.println("CART_IMG : "+tempSaveName);
		}
	}
}