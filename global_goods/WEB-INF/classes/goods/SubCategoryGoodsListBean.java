...
public class SubCategoryGoodsListBean extends MainBean
{
...
//파일꺼내기 ▲
		...
		{
			queryBuffer.append("WHERE MIDDLE_CATEGORY='"+middleCategory+"' AND SUB_CATEGORY='"+subcode+"' AND DISP_YN='Y' ");
		}
