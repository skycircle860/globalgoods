...
public class BbsInfoBean extends MainBean
{
	public void funcExecute() throws Exception
	{
		...
		String replySort = bi.getReplySort();
		String numberType = bi.getNumberType();
