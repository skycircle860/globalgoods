	...
	<TABLE cellspacing="1" cellpadding="3" bgcolor="#7682EB">
		<TR>
			<TD align="center" bgcolor="#E4F2FC" width="150">
				<FONT color="#1115AA" size="3"><B>직업 추가</B></FONT>
			</TD>
		</TR>
	</TABLE>
	<TABLE cellspacing="0" cellpadding="0">
		<TR><TD height="15" width="350"></TD></TR>
		<TR><TD> ** 추가할 직업의 이름을 입력하세요.</TD></TR>
		<TR><TD height="5"></TD></TR>
	</TABLE>
	<TABLE cellspacing="1" cellpadding="4" bgcolor="#7682EB" width="350">
		<FORM name="addForm" method="post" action="/managerJobServlet.mo" onSubmit="addAction(); return false;">
			<INPUT type="hidden" name="func" value="managerJob_007">
			<TR><TD bgcolor="#CFDDFA" align="center"><B>직 업 이 름</B></TD></TR>
			<TR>
