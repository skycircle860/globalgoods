...
<CENTER>
	...
	<TABLE cellspacing="1" cellpadding="4" bgcolor="#7682EB" width="700">
		<FORM name="addForm" action="/managerSupportServlet.mo" method="post" onSubmit="return false;">
			<INPUT type="hidden" name="func" value="managerSupport_004">
			<TR>
			...
			<TR>
				...
				<TD width="150" bgcolor="#FFFFFF"><FONT color="#A2A2A2"><INPUT type="text" name="code" size="15">
</FONT></TD>
