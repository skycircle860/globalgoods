...
<CENTER>
	...
	<TABLE cellspacing="1" cellpadding="5" bgcolor="#7682EB" width="250">
		<TR>
			<TD align="center" bgcolor="#E4F2FC" width="250">
				<FONT color="blue" size="3"><B>취미 수정</B></FONT>
			</TD>
		</TR>
	</TABLE>
	...
	<TABLE cellspacing="1" cellpadding="4" bgcolor="#7682EB" width="600">
		<FORM name="updateForm" method="post" action="/managerHobbyServlet.mo" onSubmit="updateAction(); return false;">
			<INPUT type="hidden" name="func" value="managerHobby_005">
			...
			<TR>
				...
				<TD bgcolor="#FFFFFF"><INPUT type="text" name="name" value="<%= hobbyInfoTable.get("NAME")%>"></TD>
			</TR>
			<TR>
