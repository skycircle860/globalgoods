...
<SCRIPT language="JavaScript">
	...
	function joinAction()
	{
		...
		{
			window.alert("주민 등록 번호는 숫자로 입력바랍니다.");
			f.jumin1.select();
			return false;
		}
...
<CENTER>
	...
	<TABLE cellspacing="1" cellpadding="0" bgcolor="#7682EB">
		<TR>
			<TD align="center" bgcolor="#E4F0FC" width="300" height="30">
				<FONT size="3" color="#000000"><B>회원 추가</B></FONT>
			</TD>
		</TR>
	</TABLE>
	...
	<TABLE cellspacing="1" cellpadding="5" bgcolor="#7682EB" width="700">
		<FORM name="joinForm" action="/managerUserServlet.mo" method="post" onSubmit="return false;">
			...
			<TR>
				<TD bgcolor="#CFDDFA" align="center"><B>비밀 번호</B></TD>
				<TD bgcolor="#FFFFFF" width="200"><INPUT type="password" name="pass1" maxlength="20"></TD>
				<TD bgcolor="#CFDDFA" align="center" width="110"><B>비밀번호확인</B></TD>
				<TD bgcolor="#FFFFFF"><INPUT type="password" name="pass2" maxlength="20"></TD>
			</TR>
			<TR>
				<TD bgcolor="#CFDDFA" align="center"><B>비밀번호<BR>확인시 질문</B></TD>
				<TD bgcolor="#FFFFFF" colspan="3">
					<SELECT name="passQ">
			...
			<TR>
				<TD bgcolor="#CFDDFA" align="center"><B>직장 전화</B></TD>
				<TD bgcolor="#FFFFFF" colspan="3">
					<SELECT name="office1">
						<OPTION value="000">--선택--</OPTION>
						<OPTION value="02">02</OPTION>
			...
			<TR>
				<TD bgcolor="#CFDDFA" align="center"><B>휴대 전화</B></TD>
				<TD bgcolor="#FFFFFF" colspan="3">
					<SELECT name="mobile1">
						<OPTION value="000">--선택--</OPTION>
			...
			<TR>
				<TD bgcolor="#CFDDFA" align="center"><B>주 소</B></TD>
				<TD bgcolor="#FFFFFF" colspan="3">
			...
			<TR>
				<TD bgcolor="#CFDDFA" align="center"><B>이메일</B></TD>
				<TD bgcolor="#FFFFFF" colspan="3">
					<INPUT type="text" name="email" size="60">
				</TD>
			</TR>
			<TR>
				<TD bgcolor="#CFDDFA" align="center"><B>관심상품</B></TD>
