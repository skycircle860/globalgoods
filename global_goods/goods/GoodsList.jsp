...
<SCRIPT>
	function goodsInterestAction(code)
	{
		...
		if(window.confirm("관심상품에 추가하시겠습니까?"))
		{
	...
	function goodsCartAction(code)
	{
		...
		var amount = window.prompt("담을 수량을 입력하세요~!",1);
...
%>
	<span style="margin-left:30px;">현제 페이지 : <A href="/goodsServlet.mo?func=goods_001">홈</A>><%=middleCategory_name%></span>	
...
%>
	...
	<div class="top_radius">&nbsp;&nbsp;<img src="/images/common/bul_02_01.gif" align="absmiddle">&nbsp;&nbsp;<B>전체보기</B></div>
<%
	}
%>
